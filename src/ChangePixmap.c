/* gtkgo v0.0.12 (ChangePixmap.c) (November 2022)
...
/*****************************************************************************/
{
	...
	snprintf (sPFSkin, 200, PKGDATADIR"skins/%s/%s.png",
		sCurrentSkin, Board[iPoint]);
	CheckAccess (sPFSkin);
	pixbuforig[iPoint] = gdk_pixbuf_new_from_file (sPFSkin, NULL);
